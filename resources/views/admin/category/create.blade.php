...
@section('content')
    <div class="container form-container mb-5 mt-4" style="min-height: 286px;">
       ...
       @enderror
        <form id="createProductForm" action="{{ url('admin/category') }}" method="post" enctype="multipart/form-data" style="width: 100%;">
           @csrf
            ...
            <input class="btn btn-primary mt-3 btn-lg" type="submit" value="Create Category"/>
        </form>
    </div>
@endsection